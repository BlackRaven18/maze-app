...
enum MAZE {SMALL, MEDIUM, BIG};
enum ButtonName {
    START_BTN, RESTART_BTN, BOXWHITE_BTN, BOXGREEN_BTN, BOXRED_BTN, SAVE_BTN, BFS_BTN, DFS_BTN, ONEX_BTN, TWOX_BTN, FOURX_BTN, GENERATE_BTN
};